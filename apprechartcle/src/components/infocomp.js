           ...
           <div className='sm:flex grid grid-rows-3 grid-flow-col  items-center justify-center sm:justify-between bg-[#FAFAFA]  rounded-[10px] mr-5  ml-5 mb-3  sm:p-4   sm:mb-2 sm:mr-10 sm:pr-10  '>
            <div className='ml-2   sm:mt-2'>
             ...
             <div className=" mb-2 sm:ml-10 pt-3">
              <button  className="px-7 py-1  sm:px-14 sm:py-1 bg-[#15245B] text-[#FAFAFA] text-11px sm:text-14px md:text-19px   sm:ml-2 sm:mb-2  mr-1 rounded-full sm:pr-6 sm:pl-6" onClick={()=> {navigate(`/editProfil/${name}`)} }> Modifier</button>
              <button className="px-5 py-1 sm:px-10 sm:py-1 bg-[#FAFAFA] text-[#15245B] text-11px sm:text-14px md:text-19px  rounded-full border-2 border-[#15245B] sm:pr-4 sm:pl-4" onClick={() =>{ deleteMod()}}>Supprimer</button>
             </div>
   ...
   const navigate = useNavigate();
    ...
    <section>
        <div>
                ...
                <button className=' mt-7 mr-10 px-10 py-2 bg-[#c3eefb]  text-[#15245B] text-11px sm:text-14px md:text-19px   rounded-full block ' onClick={() => {navigate("/editProfil/new")}}>Ajouter</button>
